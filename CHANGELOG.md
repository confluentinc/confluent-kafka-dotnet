...
- References librdkafka v1.3.0-RC3. Refer to the [release notes](https://github.com/edenhill/librdkafka/releases/tag/v1.3.0-RC3) for more information. Headline feature is support for fetch from follower (KIP-392).
