...
- References librdkafka v1.2.0. Refer to the [release notes](https://github.com/edenhill/librdkafka/releases/tag/v1.2.0) for more informtion. Headline feature is consumer side support for transactions.
...
- Updated the librdkaka build load order so that the most featureful version is used on any given platform.
