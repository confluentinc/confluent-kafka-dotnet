...
namespace Confluent.Kafka.UnitTests
{
    public class AclBindingTests
    {
        ...
        public void ToStringTest()
        {
            ...
            var expectedString1 = @"{""Type"": ""Topic"", ""Name"": null, ""ResourcePatternType"": ""Literal"", ""Principal"": null, ""Host"": ""h1"", ""Operation"": ""All"", ""PermissionType"": ""Allow""}";
            var expectedString2 = @"{""Type"": ""Topic"", ""Name"": null, ""ResourcePatternType"": ""Literal"", ""Principal"": null, ""Host"": ""\""h1\"""", ""Operation"": ""All"", ""PermissionType"": ""Allow""}";

            Assert.Equal(expectedString1, acl1.ToString());
            Assert.Equal(acl1.ToString(), aclFilter1.ToString());
