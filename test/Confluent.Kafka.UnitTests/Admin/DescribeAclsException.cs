...
namespace Confluent.Kafka.UnitTests
{
    public class DescribeAclsExceptionTests
    {
        ...
        public void Equality()
        {
            ...
            var ex1 = new DescribeAclsException(new DescribeAclsResult());
            var ex2 = new DescribeAclsException(new DescribeAclsResult());
            var ex3 = new DescribeAclsException(new DescribeAclsResult()
            {
            ...
            var ex4 = new DescribeAclsException(new DescribeAclsResult()
            {
            ...
            var ex5 = new DescribeAclsException(new DescribeAclsResult()
            {
                Error = new Error(ErrorCode.NoError, "Other message", false),
                AclBindings = new List<AclBinding>
                {
