...
namespace Confluent.Kafka.UnitTests.Serialization
{
    public class IntTests
    {
        ...
        {
            var bytes = Serializers.Int32(42, false, null, null);
        ...
        public void SerializationAgreesWithSystemNetHostToNetworkOrder()
        {
            foreach (int theInt in toTest)
            {
                ...
                var bytes2 = Serializers.Int32(theInt, false, null, null);
        ...
        public void CanReconstructInt()
        {
            foreach (int theInt in toTest)
            {
                var reconstructed = Deserializers.Int32(Serializers.Int32(theInt, false, null, null), false, false, null, null);
