...
namespace Confluent.Kafka.UnitTests.Serialization
{
    public class IntTests
    {
        ...
        {
            var bytes = Serializers.Int32.Serialize(42, null);
        ...
        public void SerializationAgreesWithSystemNetHostToNetworkOrder()
        {
            foreach (int theInt in toTest)
            {
                ...
                var bytes2 = Serializers.Int32.Serialize(theInt, null);
        ...
        public void CanReconstructInt()
        {
            foreach (int theInt in toTest)
            {
                var reconstructed = Deserializers.Int32.Deserialize(Serializers.Int32.Serialize(theInt, null), false, null);
