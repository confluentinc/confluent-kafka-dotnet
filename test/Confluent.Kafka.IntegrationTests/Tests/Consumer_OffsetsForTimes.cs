...
namespace Confluent.Kafka.IntegrationTests
{
    public static partial class Tests
    {
        ...
        public static void Consumer_OffsetsForTimes(string bootstrapServers, string topic, string partitionedTopic)
        {
            const int N = 10;
            const int Partition = 0;

            var messages = ProduceMessages(bootstrapServers, topic, Partition, N);
