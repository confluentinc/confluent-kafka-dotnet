...
{
    public class KafkaParameters : IEnumerable<object[]>
    {
        private static readonly List<object[]> kafkaParameters;

        static KafkaParameters()
        {
            var codeBase = typeof(KafkaParameters).GetTypeInfo().Assembly.CodeBase;
        ...
        { return kafkaParameters.GetEnumerator(); }
