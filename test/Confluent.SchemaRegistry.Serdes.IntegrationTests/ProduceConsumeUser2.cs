...
namespace Confluent.Kafka.Examples.AvroSpecific
{
    ...
    public partial class ProduceConsumeUser2 : ISpecificRecord
    {
        public static Schema _SCHEMA = Schema.Parse("{\"type\":\"record\",\"name\":\"ProduceConsumeUser2\",\"namespace\":\"Confluent.Kafka.Examples.AvroSpecific" +
        ...
        public virtual Schema Schema
        {
            get
            {
                return ProduceConsumeUser2._SCHEMA;
            }
        }
        public string name
        {
