...
namespace Confluent.Kafka.Examples.AvroSpecific
{
    ...
    public partial class UserWithPic : ISpecificRecord
    {
        public static Schema _SCHEMA = Schema.Parse("{\"type\":\"record\",\"name\":\"UserWithPic\",\"namespace\":\"Confluent.Kafka.Examples.AvroSpecific" +
        ...
        public virtual void Put(int fieldPos, object fieldValue)
        {
            switch (fieldPos)
            {
                ...
                case 3: this.picture = (System.Byte[])fieldValue; break;
