...
namespace Confluent.Kafka.Examples.AvroSpecific
{
    ...
    public partial class NewUser : ISpecificRecord
    {
        public static Schema _SCHEMA = Schema.Parse("{\"type\":\"record\",\"name\":\"NewUser\",\"namespace\":\"Confluent.Kafka.Examples.AvroSpecific" +
                "\",\"fields\":[{\"name\":\"full_name\",\"type\":\"string\"},{\"name\":\"favorite_number\",\"type\":[\"i" +
        ...
        public virtual void Put(int fieldPos, object fieldValue)
        {
            switch (fieldPos)
            {
                case 0: this.full_name = (System.String)fieldValue; break;
