    ...
    public static partial class Tests
    {
        ...
        public static void PrimitiveTypes(string bootstrapServers, string schemaRegistryServers)
        {
            ...
            using (var serdeProvider = new AvroSerdeProvider(serdeProviderConfig))
            {
                ...
                using (var producer = new Producer<byte[], byte[]>(producerConfig, serdeProvider.SerializerGenerator<byte[]>(), serdeProvider.SerializerGenerator<byte[]>()))
                {
                ...
                using (var producer = new Producer<int, int>(producerConfig, serdeProvider.SerializerGenerator<int>(), serdeProvider.SerializerGenerator<int>()))
                {
                ...
                using (var producer = new Producer<long, long>(producerConfig, serdeProvider.SerializerGenerator<long>(), serdeProvider.SerializerGenerator<long>()))
                {
                ...
                using (var producer = new Producer<bool, bool>(producerConfig, serdeProvider.SerializerGenerator<bool>(), serdeProvider.SerializerGenerator<bool>()))
                {
                ...
                using (var producer = new Producer<float, float>(producerConfig, serdeProvider.SerializerGenerator<float>(), serdeProvider.SerializerGenerator<float>()))
                {
                ...
                using (var producer = new Producer<double, double>(producerConfig, serdeProvider.SerializerGenerator<double>(), serdeProvider.SerializerGenerator<double>()))
                {
                ...
                using (var producer = new Producer<Null,Null>(producerConfig, serdeProvider.SerializerGenerator<Null>(), serdeProvider.SerializerGenerator<Null>()))
                {
                ...
                using (var consumer = new Consumer<byte[], byte[]>(consumerConfig, serdeProvider.DeserializerGenerator<byte[]>(), serdeProvider.DeserializerGenerator<byte[]>()))
                {
                ...
                using (var consumer = new Consumer<int, int>(consumerConfig, serdeProvider.DeserializerGenerator<int>(), serdeProvider.DeserializerGenerator<int>()))
                {
                ...
                using (var consumer = new Consumer<long, long>(consumerConfig, serdeProvider.DeserializerGenerator<long>(), serdeProvider.DeserializerGenerator<long>()))
                {
                ...
                using (var consumer = new Consumer<bool, bool>(consumerConfig, serdeProvider.DeserializerGenerator<bool>(), serdeProvider.DeserializerGenerator<bool>()))
                {
                ...
                using (var consumer = new Consumer<float, float>(consumerConfig, serdeProvider.DeserializerGenerator<float>(), serdeProvider.DeserializerGenerator<float>()))
                {
                ...
                using (var consumer = new Consumer<double, double>(consumerConfig, serdeProvider.DeserializerGenerator<double>(), serdeProvider.DeserializerGenerator<double>()))
                {
                ...
                using (var consumer = new Consumer<Null, Null>(consumerConfig, serdeProvider.DeserializerGenerator<Null>(), serdeProvider.DeserializerGenerator<Null>()))
                {
