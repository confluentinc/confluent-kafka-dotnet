...
- [Confluent.Kafka.OAuthBearer.Aws](https://www.nuget.org/packages/Confluent.Kafka.OAuthBearer.Aws/) *[netstandard2.1, net462, net6.0, net8.0, net10.0]* - Optional AWS IAM-based OAUTHBEARER authentication for Confluent.Kafka.
