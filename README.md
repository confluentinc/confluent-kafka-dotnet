...
```
dotnet add package -v 1.0-beta Confluent.Kafka
```

**Note:** We recommend using the `1.0-beta` version of Confluent.Kafka for new projects in preference to the most recent stable release (0.11.5).
