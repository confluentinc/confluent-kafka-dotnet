...
namespace Confluent.Kafka.Impl
{
    internal static class Librdkafka
    {
        ...
        static bool SetDelegates(Type nativeMethodsClass)
        {
            ...
            _message_status = (Func<IntPtr, MessageStatus>)methods.Single(m => m.Name == "rd_kafka_message_status").CreateDelegate(typeof(Func<IntPtr, MessageStatus>));
        ...
        private static Func<IntPtr, MessageStatus> _message_status;
        internal static MessageStatus message_status(IntPtr rkmessage) => _message_status(rkmessage);
