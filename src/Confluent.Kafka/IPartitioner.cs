...
namespace Confluent.Kafka
{
    ...
    public interface IPartitioner : IDisposable
    {
        ...
        /// </summary>
        /// <param name="topic">
        ///     The topic to partition for.
        /// </param>
        /// <param name="keydata">
        ///     Pointer to the Key's data.
        /// </param>
        /// <param name="keylen">
        ///     The lenght of the Key's data.
        /// </param>
        /// <param name="partition_cnt">
        ///     The known count of known partitions for the Topic.
        /// </param>
        /// <param name="rkt_opaque">
        ///     The rkt_opaque argument is the opaque set by rd_kafka_topic_conf_set_opaque().
        /// </param>
        /// <param name="msg_opaque">
        ///     The msg_opaque argument is the per-message opaque passed to produce().
        /// </param>
        /// <returns>
        ///     The calculated <seealso cref="Confluent.Kafka.Partition"/> or <seealso cref="Confluent.Kafka.Partition.Any"/> if partitioning could not be performed.
        /// </returns>
