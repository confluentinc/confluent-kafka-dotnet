...
namespace Confluent.Kafka
{
    ...
    public class ClientConfig : IEnumerable<KeyValuePair<string, string>>
    {
        ...
        ///     Client identifier.
        /// </summary>
        public string ClientId { get { return this.properties["client.id"]; } set { this.SetObject("client.id", value); } }
        ...
        /// </summary>
        public string BootstrapServers { get { return this.properties["bootstrap.servers"]; } set { this.SetObject("bootstrap.servers", value); } }

        /// <summary>
        ///     Maximum Kafka protocol request message size.
        /// </summary>
        public int MessageMaxBytes { get { return int.Parse(this.properties["message.max.bytes"]); } set { this.SetObject("message.max.bytes", value); } }
        ...
        /// </summary>
        public int MessageCopyMaxBytes { get { return int.Parse(this.properties["message.copy.max.bytes"]); } set { this.SetObject("message.copy.max.bytes", value); } }
        ...
        /// </summary>
        public int ReceiveMessageMaxBytes { get { return int.Parse(this.properties["receive.message.max.bytes"]); } set { this.SetObject("receive.message.max.bytes", value); } }

        /// <summary>
        ///     Maximum number of in-flight requests per broker connection. This is a generic property applied to all broker communication, however it is primarily relevant to produce requests. In particular, note that other mechanisms limit the number of outstanding consumer fetch request per broker to one.
        /// </summary>
        public int MaxInFlight { get { return int.Parse(this.properties["max.in.flight"]); } set { this.SetObject("max.in.flight", value); } }

        /// <summary>
        ///     Non-topic request timeout in milliseconds. This is for metadata requests, etc.
        /// </summary>
        public int MetadataRequestTimeoutMs { get { return int.Parse(this.properties["metadata.request.timeout.ms"]); } set { this.SetObject("metadata.request.timeout.ms", value); } }
        ...
        /// </summary>
        public int TopicMetadataRefreshIntervalMs { get { return int.Parse(this.properties["topic.metadata.refresh.interval.ms"]); } set { this.SetObject("topic.metadata.refresh.interval.ms", value); } }

        /// <summary>
        ///     Metadata cache max age. Defaults to topic.metadata.refresh.interval.ms * 3
        /// </summary>
        public int MetadataMaxAgeMs { get { return int.Parse(this.properties["metadata.max.age.ms"]); } set { this.SetObject("metadata.max.age.ms", value); } }
        ...
        /// </summary>
        public int TopicMetadataRefreshFastIntervalMs { get { return int.Parse(this.properties["topic.metadata.refresh.fast.interval.ms"]); } set { this.SetObject("topic.metadata.refresh.fast.interval.ms", value); } }

        /// <summary>
        ///     Sparse metadata requests (consumes less network bandwidth)
        /// </summary>
        public bool TopicMetadataRefreshSparse { get { return bool.Parse(this.properties["topic.metadata.refresh.sparse"]); } set { this.SetObject("topic.metadata.refresh.sparse", value); } }
        ...
        /// </summary>
        public string TopicBlacklist { get { return this.properties["topic.blacklist"]; } set { this.SetObject("topic.blacklist", value); } }
        ...
        /// </summary>
        public string Debug { get { return this.properties["debug"]; } set { this.SetObject("debug", value); } }
        ...
        /// </summary>
        public int SocketTimeoutMs { get { return int.Parse(this.properties["socket.timeout.ms"]); } set { this.SetObject("socket.timeout.ms", value); } }
        ...
        /// </summary>
        public int SocketBlockingMaxMs { get { return int.Parse(this.properties["socket.blocking.max.ms"]); } set { this.SetObject("socket.blocking.max.ms", value); } }

        /// <summary>
        ///     Broker socket send buffer size. System default is used if 0.
        /// </summary>
        public int SocketSendBufferBytes { get { return int.Parse(this.properties["socket.send.buffer.bytes"]); } set { this.SetObject("socket.send.buffer.bytes", value); } }

        /// <summary>
        ///     Broker socket receive buffer size. System default is used if 0.
        /// </summary>
        public int SocketReceiveBufferBytes { get { return int.Parse(this.properties["socket.receive.buffer.bytes"]); } set { this.SetObject("socket.receive.buffer.bytes", value); } }

        /// <summary>
        ///     Enable TCP keep-alives (SO_KEEPALIVE) on broker sockets
        /// </summary>
        public bool SocketKeepaliveEnable { get { return bool.Parse(this.properties["socket.keepalive.enable"]); } set { this.SetObject("socket.keepalive.enable", value); } }

        /// <summary>
        ///     Disable the Nagle algorithm (TCP_NODELAY) on broker sockets.
        /// </summary>
        public bool SocketNagleDisable { get { return bool.Parse(this.properties["socket.nagle.disable"]); } set { this.SetObject("socket.nagle.disable", value); } }
        ...
        /// </summary>
        public int SocketMaxFails { get { return int.Parse(this.properties["socket.max.fails"]); } set { this.SetObject("socket.max.fails", value); } }

        /// <summary>
        ///     How long to cache the broker address resolving results (milliseconds).
        /// </summary>
        public int BrokerAddressTtl { get { return int.Parse(this.properties["broker.address.ttl"]); } set { this.SetObject("broker.address.ttl", value); } }

        /// <summary>
        ///     Allowed broker IP address families: any, v4, v6
        /// </summary>
        public BrokerAddressFamilyType BrokerAddressFamily { get { return (BrokerAddressFamilyType)Enum.Parse(typeof(BrokerAddressFamilyType), this.properties["broker.address.family"]); } set { this.SetObject("broker.address.family", value); } }

        /// <summary>
        ///     Throttle broker reconnection attempts by this value +-50%.
        /// </summary>
        public int ReconnectBackoffJitterMs { get { return int.Parse(this.properties["reconnect.backoff.jitter.ms"]); } set { this.SetObject("reconnect.backoff.jitter.ms", value); } }
        ...
        /// </summary>
        public int StatisticsIntervalMs { get { return int.Parse(this.properties["statistics.interval.ms"]); } set { this.SetObject("statistics.interval.ms", value); } }

        /// <summary>
        ///     Logging level (syslog(3) levels)
        /// </summary>
        public int Log_level { get { return int.Parse(this.properties["log_level"]); } set { this.SetObject("log_level", value); } }
        ...
        /// </summary>
        public bool LogQueue { get { return bool.Parse(this.properties["log.queue"]); } set { this.SetObject("log.queue", value); } }

        /// <summary>
        ///     Print internal thread name in log messages (useful for debugging librdkafka internals)
        /// </summary>
        public bool LogThreadName { get { return bool.Parse(this.properties["log.thread.name"]); } set { this.SetObject("log.thread.name", value); } }
        ...
        /// </summary>
        public bool LogConnectionClose { get { return bool.Parse(this.properties["log.connection.close"]); } set { this.SetObject("log.connection.close", value); } }

        /// <summary>
        ///     Signal that librdkafka will use to quickly terminate on rd_kafka_destroy(). If this signal is not set then there will be a delay before rd_kafka_wait_destroyed() returns true as internal threads are timing out their system calls. If this signal is set however the delay will be minimal. The application should mask this signal as an internal signal handler is installed.
        /// </summary>
        public int InternalTerminationSignal { get { return int.Parse(this.properties["internal.termination.signal"]); } set { this.SetObject("internal.termination.signal", value); } }
        ...
        /// </summary>
        public bool ApiVersionRequest { get { return bool.Parse(this.properties["api.version.request"]); } set { this.SetObject("api.version.request", value); } }

        /// <summary>
        ///     Timeout for broker API version requests.
        /// </summary>
        public int ApiVersionRequestTimeoutMs { get { return int.Parse(this.properties["api.version.request.timeout.ms"]); } set { this.SetObject("api.version.request.timeout.ms", value); } }
        ...
        /// </summary>
        public int ApiVersionFallbackMs { get { return int.Parse(this.properties["api.version.fallback.ms"]); } set { this.SetObject("api.version.fallback.ms", value); } }
        ...
        /// </summary>
        public string BrokerVersionFallback { get { return this.properties["broker.version.fallback"]; } set { this.SetObject("broker.version.fallback", value); } }

        /// <summary>
        ///     Protocol used to communicate with brokers.
        /// </summary>
        public SecurityProtocolType SecurityProtocol { get { return (SecurityProtocolType)Enum.Parse(typeof(SecurityProtocolType), this.properties["security.protocol"]); } set { this.SetObject("security.protocol", value); } }
        ...
        /// </summary>
        public string SslCipherSuites { get { return this.properties["ssl.cipher.suites"]; } set { this.SetObject("ssl.cipher.suites", value); } }
        ...
        /// </summary>
        public string SslCurvesList { get { return this.properties["ssl.curves.list"]; } set { this.SetObject("ssl.curves.list", value); } }
        ...
        /// </summary>
        public string SslSigalgsList { get { return this.properties["ssl.sigalgs.list"]; } set { this.SetObject("ssl.sigalgs.list", value); } }

        /// <summary>
        ///     Path to client's private key (PEM) used for authentication.
        /// </summary>
        public string SslKeyLocation { get { return this.properties["ssl.key.location"]; } set { this.SetObject("ssl.key.location", value); } }

        /// <summary>
        ///     Private key passphrase
        /// </summary>
        public string SslKeyPassword { get { return this.properties["ssl.key.password"]; } set { this.SetObject("ssl.key.password", value); } }

        /// <summary>
        ///     Path to client's public key (PEM) used for authentication.
        /// </summary>
        public string SslCertificateLocation { get { return this.properties["ssl.certificate.location"]; } set { this.SetObject("ssl.certificate.location", value); } }

        /// <summary>
        ///     File or directory path to CA certificate(s) for verifying the broker's key.
        /// </summary>
        public string SslCaLocation { get { return this.properties["ssl.ca.location"]; } set { this.SetObject("ssl.ca.location", value); } }

        /// <summary>
        ///     Path to CRL for verifying broker's certificate validity.
        /// </summary>
        public string SslCrlLocation { get { return this.properties["ssl.crl.location"]; } set { this.SetObject("ssl.crl.location", value); } }

        /// <summary>
        ///     Path to client's keystore (PKCS#12) used for authentication.
        /// </summary>
        public string SslKeystoreLocation { get { return this.properties["ssl.keystore.location"]; } set { this.SetObject("ssl.keystore.location", value); } }

        /// <summary>
        ///     Client's keystore (PKCS#12) password.
        /// </summary>
        public string SslKeystorePassword { get { return this.properties["ssl.keystore.password"]; } set { this.SetObject("ssl.keystore.password", value); } }
        ...
        /// </summary>
        public string SaslMechanism { get { return this.properties["sasl.mechanism"]; } set { this.SetObject("sasl.mechanism", value); } }

        /// <summary>
        ///     Kerberos principal name that Kafka runs as, not including /hostname@REALM
        /// </summary>
        public string SaslKerberosServiceName { get { return this.properties["sasl.kerberos.service.name"]; } set { this.SetObject("sasl.kerberos.service.name", value); } }

        /// <summary>
        ///     This client's Kerberos principal name. (Not supported on Windows, will use the logon user's principal).
        /// </summary>
        public string SaslKerberosPrincipal { get { return this.properties["sasl.kerberos.principal"]; } set { this.SetObject("sasl.kerberos.principal", value); } }
        ...
        /// </summary>
        public string SaslKerberosKinitCmd { get { return this.properties["sasl.kerberos.kinit.cmd"]; } set { this.SetObject("sasl.kerberos.kinit.cmd", value); } }
        ...
        /// </summary>
        public string SaslKerberosKeytab { get { return this.properties["sasl.kerberos.keytab"]; } set { this.SetObject("sasl.kerberos.keytab", value); } }

        /// <summary>
        ///     Minimum time in milliseconds between key refresh attempts.
        /// </summary>
        public int SaslKerberosMinTimeBeforeRelogin { get { return int.Parse(this.properties["sasl.kerberos.min.time.before.relogin"]); } set { this.SetObject("sasl.kerberos.min.time.before.relogin", value); } }

        /// <summary>
        ///     SASL username for use with the PLAIN and SASL-SCRAM-.. mechanisms
        /// </summary>
        public string SaslUsername { get { return this.properties["sasl.username"]; } set { this.SetObject("sasl.username", value); } }

        /// <summary>
        ///     SASL password for use with the PLAIN and SASL-SCRAM-.. mechanism
        /// </summary>
        public string SaslPassword { get { return this.properties["sasl.password"]; } set { this.SetObject("sasl.password", value); } }
        ...
        /// </summary>
        public string PluginLibraryPaths { get { return this.properties["plugin.library.paths"]; } set { this.SetObject("plugin.library.paths", value); } }

        /// <summary>
        ///     Client group id string. All clients sharing the same group.id belong to the same group.
        /// </summary>
        public string GroupId { get { return this.properties["group.id"]; } set { this.SetObject("group.id", value); } }

        /// <summary>
        ///     Name of partition assignment strategy to use when elected group leader assigns partitions to group members.
        /// </summary>
        public string PartitionAssignmentStrategy { get { return this.properties["partition.assignment.strategy"]; } set { this.SetObject("partition.assignment.strategy", value); } }

        /// <summary>
        ///     Client group session and failure detection timeout.
        /// </summary>
        public int SessionTimeoutMs { get { return int.Parse(this.properties["session.timeout.ms"]); } set { this.SetObject("session.timeout.ms", value); } }

        /// <summary>
        ///     Group session keepalive heartbeat interval.
        /// </summary>
        public int HeartbeatIntervalMs { get { return int.Parse(this.properties["heartbeat.interval.ms"]); } set { this.SetObject("heartbeat.interval.ms", value); } }

        /// <summary>
        ///     Group protocol type
        /// </summary>
        public string GroupProtocolType { get { return this.properties["group.protocol.type"]; } set { this.SetObject("group.protocol.type", value); } }
        ...
        /// </summary>
        public int CoordinatorQueryIntervalMs { get { return int.Parse(this.properties["coordinator.query.interval.ms"]); } set { this.SetObject("coordinator.query.interval.ms", value); } }
    ...
    public class ProducerConfig : ClientConfig
    {
        ...
        /// </summary>
        public int QueueBufferingMaxMessages { get { return int.Parse(this.properties["queue.buffering.max.messages"]); } set { this.SetObject("queue.buffering.max.messages", value); } }
        ...
        /// </summary>
        public int QueueBufferingMaxKbytes { get { return int.Parse(this.properties["queue.buffering.max.kbytes"]); } set { this.SetObject("queue.buffering.max.kbytes", value); } }

        /// <summary>
        ///     Delay in milliseconds to wait for messages in the producer queue to accumulate before constructing message batches (MessageSets) to transmit to brokers. A higher value allows larger and more effective (less overhead, improved compression) batches of messages to accumulate at the expense of increased message delivery latency.
        /// </summary>
        public int LingerMs { get { return int.Parse(this.properties["linger.ms"]); } set { this.SetObject("linger.ms", value); } }

        /// <summary>
        ///     How many times to retry sending a failing MessageSet. **Note:** retrying may cause reordering.
        /// </summary>
        public int MessageSendMaxRetries { get { return int.Parse(this.properties["message.send.max.retries"]); } set { this.SetObject("message.send.max.retries", value); } }

        /// <summary>
        ///     The backoff time in milliseconds before retrying a protocol request.
        /// </summary>
        public int RetryBackoffMs { get { return int.Parse(this.properties["retry.backoff.ms"]); } set { this.SetObject("retry.backoff.ms", value); } }

        /// <summary>
        ///     The threshold of outstanding not yet transmitted broker requests needed to backpressure the producer's message accumulator. If the number of not yet transmitted requests equals or exceeds this number, produce request creation that would have otherwise been triggered (for example, in accordance with linger.ms) will be delayed. A lower number yields larger and more effective batches. A higher value can improve latency when using compression on slow machines.
        /// </summary>
        public int QueueBufferingBackpressureThreshold { get { return int.Parse(this.properties["queue.buffering.backpressure.threshold"]); } set { this.SetObject("queue.buffering.backpressure.threshold", value); } }

        /// <summary>
        ///     Maximum number of messages batched in one MessageSet. The total MessageSet size is also limited by message.max.bytes.
        /// </summary>
        public int BatchNumMessages { get { return int.Parse(this.properties["batch.num.messages"]); } set { this.SetObject("batch.num.messages", value); } }
        ...
        /// </summary>
        public int Acks { get { return int.Parse(this.properties["acks"]); } set { this.SetObject("acks", value); } }
        ...
        /// </summary>
        public int RequestTimeoutMs { get { return int.Parse(this.properties["request.timeout.ms"]); } set { this.SetObject("request.timeout.ms", value); } }

        /// <summary>
        ///     Local message timeout. This value is only enforced locally and limits the time a produced message waits for successful delivery. A time of 0 is infinite. This is the maximum time librdkafka may use to deliver a message (including retries). Delivery error occurs when either the retry count or the message timeout are exceeded.
        /// </summary>
        public int MessageTimeoutMs { get { return int.Parse(this.properties["message.timeout.ms"]); } set { this.SetObject("message.timeout.ms", value); } }
        ...
        /// </summary>
        public QueuingStrategyType QueuingStrategy { get { return (QueuingStrategyType)Enum.Parse(typeof(QueuingStrategyType), this.properties["queuing.strategy"]); } set { this.SetObject("queuing.strategy", value); } }
        ...
        /// </summary>
        public string Partitioner { get { return this.properties["partitioner"]; } set { this.SetObject("partitioner", value); } }
        ...
        /// </summary>
        public int CompressionLevel { get { return int.Parse(this.properties["compression.level"]); } set { this.SetObject("compression.level", value); } }
    ...
    public class ConsumerConfig : ClientConfig
    {
        ...
        /// </summary>
        public bool EnableAutoCommit { get { return bool.Parse(this.properties["enable.auto.commit"]); } set { this.SetObject("enable.auto.commit", value); } }
        ...
        /// </summary>
        public int AutoCommitIntervalMs { get { return int.Parse(this.properties["auto.commit.interval.ms"]); } set { this.SetObject("auto.commit.interval.ms", value); } }

        /// <summary>
        ///     Automatically store offset of last message provided to application.
        /// </summary>
        public bool EnableAutoOffsetStore { get { return bool.Parse(this.properties["enable.auto.offset.store"]); } set { this.SetObject("enable.auto.offset.store", value); } }

        /// <summary>
        ///     Minimum number of messages per topic+partition librdkafka tries to maintain in the local consumer queue.
        /// </summary>
        public int QueuedMinMessages { get { return int.Parse(this.properties["queued.min.messages"]); } set { this.SetObject("queued.min.messages", value); } }
        ...
        /// </summary>
        public int QueuedMaxMessagesKbytes { get { return int.Parse(this.properties["queued.max.messages.kbytes"]); } set { this.SetObject("queued.max.messages.kbytes", value); } }

        /// <summary>
        ///     Maximum time the broker may wait to fill the response with fetch.min.bytes.
        /// </summary>
        public int FetchWaitMaxMs { get { return int.Parse(this.properties["fetch.wait.max.ms"]); } set { this.SetObject("fetch.wait.max.ms", value); } }

        /// <summary>
        ///     Initial maximum number of bytes per topic+partition to request when fetching messages from the broker. If the client encounters a message larger than this value it will gradually try to increase it until the entire message can be fetched.
        /// </summary>
        public int MaxPartitionFetchBytes { get { return int.Parse(this.properties["max.partition.fetch.bytes"]); } set { this.SetObject("max.partition.fetch.bytes", value); } }

        /// <summary>
        ///     Maximum amount of data the broker shall return for a Fetch request. Messages are fetched in batches by the consumer and if the first message batch in the first non-empty partition of the Fetch request is larger than this value, then the message batch will still be returned to ensure the consumer can make progress. The maximum message batch size accepted by the broker is defined via `message.max.bytes` (broker config) or `max.message.bytes` (broker topic config). `fetch.max.bytes` is automatically adjusted upwards to be at least `message.max.bytes` (consumer config).
        /// </summary>
        public int FetchMaxBytes { get { return int.Parse(this.properties["fetch.max.bytes"]); } set { this.SetObject("fetch.max.bytes", value); } }
        ...
        /// </summary>
        public int FetchMinBytes { get { return int.Parse(this.properties["fetch.min.bytes"]); } set { this.SetObject("fetch.min.bytes", value); } }

        /// <summary>
        ///     How long to postpone the next fetch request for a topic+partition in case of a fetch error.
        /// </summary>
        public int FetchErrorBackoffMs { get { return int.Parse(this.properties["fetch.error.backoff.ms"]); } set { this.SetObject("fetch.error.backoff.ms", value); } }

        /// <summary>
        ///     Emit RD_KAFKA_RESP_ERR__PARTITION_EOF event whenever the consumer reaches the end of a partition.
        /// </summary>
        public bool EnablePartitionEof { get { return bool.Parse(this.properties["enable.partition.eof"]); } set { this.SetObject("enable.partition.eof", value); } }
        ...
        /// </summary>
        public bool CheckCrcs { get { return bool.Parse(this.properties["check.crcs"]); } set { this.SetObject("check.crcs", value); } }

        /// <summary>
        ///     Action to take when there is no initial offset in offset store or the desired offset is out of range: 'smallest','earliest' - automatically reset the offset to the smallest offset, 'largest','latest' - automatically reset the offset to the largest offset, 'error' - trigger an error which is retrieved by consuming messages and checking 'message->err'.
        /// </summary>
        public AutoOffsetResetType AutoOffsetReset { get { return (AutoOffsetResetType)Enum.Parse(typeof(AutoOffsetResetType), this.properties["auto.offset.reset"]); } set { this.SetObject("auto.offset.reset", value); } }
