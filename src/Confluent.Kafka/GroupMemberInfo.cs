...
namespace Confluent.Kafka
{
    ...
    public class GroupMemberInfo
    {
        ...
        /// </param>
        /// <param name="memberAssignmentTopicPartitions">
        ///     Gets the parsed list of TopicPartitionOffset that are encoded inside MemberAssignment.
        /// </param>
        public GroupMemberInfo(string memberId, string clientId, string clientHost, byte[] memberMetadata,
            byte[] memberAssignment, List<TopicPartition> memberAssignmentTopicPartitions)
        {
            MemberId = memberId;
            ClientId = clientId;
            ...
            MemberAssignmentTopicPartitions = memberAssignmentTopicPartitions;
        }

        /// <summary>
        ///     Gets the member id generated by broker (consumer id).
        /// </summary>
