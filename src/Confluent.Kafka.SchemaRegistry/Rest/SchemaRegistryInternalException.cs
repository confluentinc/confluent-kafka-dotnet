...
namespace  Confluent.Kafka.SchemaRegistry.Rest
{
    ...
    ///     an HTTP status indicating an error (any 400 or 500 statuses). For example, a 
    ///     request entity that omits a required field may generate the following response:
    /// </summary>
