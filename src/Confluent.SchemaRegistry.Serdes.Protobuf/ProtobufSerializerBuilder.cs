...
namespace Confluent.SchemaRegistry.Serdes
{
    ...
    ///     </code>
    /// </example>
    public class ProtobufSerializerBuilder<T>
        : SchemaRegistrySerdeBuilder<ProtobufSerializerBuilder<T>>, IAsyncSerializerBuilder<T>
        where T : IMessage<T>, new()
    {
        private ProtobufSerializerConfig serializerConfig;

        /// <summary>
        ///     The serializer configuration (refer to
        ///     <see cref="ProtobufSerializerConfig" />).
        /// </summary>
        public ProtobufSerializerBuilder<T> SetSerializerConfig(ProtobufSerializerConfig serializerConfig)
        {
        ...
        public IAsyncSerializer<T> Build(IEnumerable<KeyValuePair<string, string>> config, bool isKey)
        {
            ...
            var serializer = new ProtobufSerializer<T>(client, serializerConfig, ruleRegistry);
