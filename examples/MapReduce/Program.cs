...
/// </summary>
namespace Confluent.Kafka.Examples.MapReduce
{
    public class Program
    {
        ...
        static async Task Generator_LineInputData(string brokerList, string clientId, CancellationToken ct)
        {
            ...
            var r = await client.GetAsync("https://raw.githubusercontent.com/confluentinc/confluent-kafka-dotnet/master/examples/MapReduce/Program.cs", ct);
