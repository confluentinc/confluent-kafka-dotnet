...
public static partial class UserReflection {
  ...
  static UserReflection() {
    byte[] descriptorData = global::System.Convert.FromBase64String(
        string.Concat(
          "Cgp1c2VyLnByb3RvIkMKBFVzZXISDAoETmFtZRgBIAEoCRIWCg5GYXZvcml0",
          "ZU51bWJlchgCIAEoAxIVCg1GYXZvcml0ZUNvbG9yGAMgASgJYgZwcm90bzM="));
    descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
        new pbr::FileDescriptor[] { },
        new pbr::GeneratedClrTypeInfo(null, new pbr::GeneratedClrTypeInfo[] {
          new pbr::GeneratedClrTypeInfo(typeof(global::User), global::User.Parser, new[]{ "Name", "FavoriteNumber", "FavoriteColor" }, null, null, null)
        }));
  }
  #endregion
...
public sealed partial class User : pb::IMessage<User> {
  ...
  public override int GetHashCode() {
    ...
    if (FavoriteNumber != 0L) hash ^= FavoriteNumber.GetHashCode();
  ...
  public void WriteTo(pb::CodedOutputStream output) {
    ...
    if (FavoriteNumber != 0L) {
      output.WriteRawTag(16);
      output.WriteInt64(FavoriteNumber);
    }
  ...
  public int CalculateSize() {
    ...
    if (FavoriteNumber != 0L) {
      size += 1 + pb::CodedOutputStream.ComputeInt64Size(FavoriteNumber);
    }
    if (FavoriteColor.Length != 0) {
  ...
  public void MergeFrom(pb::CodedInputStream input) {
    ...
    while ((tag = input.ReadTag()) != 0) {
      switch(tag) {
        ...
        case 16: {
          FavoriteNumber = input.ReadInt64();
          break;
        }
        case 26: {
